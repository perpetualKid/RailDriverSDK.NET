...
namespace PIEHid32Net
{
	...
	{
		void HandlePIEHidError( PIEDevice sourceDevices, Int32 error);
	}
	...
	public class PIEDevice
	{
		...
		private Int32 hidUsage;
		private Int32 hidUsagePage;
		...
		public Int32 HidUsage
		{
			get { return hidUsage; }
		}
		public Int32 HidUsagePage
		{
...
*/
		public PIEDevice(String path, Int32 vid, Int32 pid, Int32 version,
			Int32 hidUsage, Int32 hidUsagePage, Int32 readSize, Int32 writeSize,
            String ManufacturersString,String ProductString)
		{
			...
			this.inputReportSize = readSize;
			this.outputReportSize = writeSize;
...
//--------------------------------------------------------------------------------------------
        ...
        public String GetErrorString(int errNumb)
        {
            ...
            EDS[26] = 307; EDA[26] = "307 Device disconnected";
            EDS[27] = 308; EDA[27] = "308 ";
            EDS[28] = 309; EDA[28] = "309 ";
            ...
            EDS[58] = 412; EDA[58] = "412 ReportID error.";
...
//-------------------------------------------------------------------------------------------
        ...
        protected void WriteThread()
        {
         //   FileIOApiDeclarations.SECURITY_ATTRIBUTES securityAttrUnused = new FileIOApiDeclarations.SECURITY_ATTRIBUTES();
            ...
            overlapped.hEvent = (Int32)overlapEvent;
            overlapped.Internal = 0; //IntPtr.Zero;
            overlapped.InternalHigh = 0;//IntPtr.Zero;
...
//-----------------------------------------------------------------------------
        ...
        public Int32 SetupInterface()
       {
        ...
        public Int32 SetDataCallback(PIEDataHandler handler)
        {
		...
		public Int32 SetErrorCallback(PIEErrorHandler handler)
		{
...
//--------------------------------------------------------------------------------------------
		...
		public Int32 ConvertToSplatMode()
		{
			return SendSausageCommands(convertToSplatModeSausages);
		}
		public Int32 SendLEDSausage()
		{
		...
		{
            //patti removed code for Jimmy customer
            r0 = 0;
            r1 = 0;
            r2 = 0;
            r3 = 0;
